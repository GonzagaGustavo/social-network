/*
  ...
  - You are about to alter the column `created` on the `country` table. The data in that column could be lost. The data in that column will be cast from `DateTime(0)` to `DateTime`.
...
*/
-- AlterTable
ALTER TABLE `country` MODIFY `created` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;
